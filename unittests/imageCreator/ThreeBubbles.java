...
//
//
//public class ThreeBubbles {
//
//    @Test
//    void testTreeBubbles() {
//        Scene scene = new Scene("ThreeBubblesSoftShadows");
//        //bubbles
...
//                .setImageWriter(new ImageWriter("ThreeBubblesSoftShadows", 800, 800))
//                .setRayTracer(new SimpleRayTracer(scene).setNumSamples(3));
//
//        // Render the image
//        camera.build()
//                .renderImage()
